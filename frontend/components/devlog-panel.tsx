...
export function DevlogPanel() {
  ...
  return (
    <Panel
      ...
      description="Devlog : ajoutez les changements du site, nouvelles fonctionnalités et retours de réunion."
    >
      ...
      {sorted.length === 0 ? (
        <p className="news-empty">Aucune entrée pour le moment. Ajoutez la première via le formulaire ci-dessus.</p>
      ) : (
